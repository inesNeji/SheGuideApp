...
const teamMembers = [
  {
    ...
    description:
      "Rebecca Off verantwortet Business Development und operative Unternehmensentwicklung.",
    image: "/assets/images/rebecca-off.png",
  },
];
  ...
  return (
    ...
    >
      ...
      <motion.section
        ...
        data-ocid="dashboard.team.section"
      >
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-display-md text-foreground">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Strategic support for SheGuide's startup development and operational growth.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {teamMembers.map((member) => (
            <Card
              key={member.name}
              className="p-5 border hover:shadow-card-sm transition-smooth"
              data-ocid="dashboard.team.rebecca_off_card"
            >
              <div className="flex items-center gap-4">
                <img
                  src={member.image}
                  alt={member.name}
                  className="w-20 h-20 rounded-2xl object-cover border border-border shadow-subtle shrink-0"
                />
                <div>
